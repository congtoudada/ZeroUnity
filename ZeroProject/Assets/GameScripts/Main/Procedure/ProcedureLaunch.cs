using ZeroEngine;
using YooAsset;
using ProcedureOwner = ZeroEngine.IFsm<ZeroEngine.IProcedureManager>;
...
namespace GameMain
{
    ...
    public class ProcedureLaunch : ProcedureBase
    {
        ...
        {
            if (GameModule.Resource.PlayMode == EPlayMode.EditorSimulateMode && GameModule.Root.EditorLanguage == Language.Unspecified)
            {
