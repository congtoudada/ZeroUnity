...
namespace ZeroEngine
{
    ...
    public abstract class UIBase
    {
        ...
        /// 代码自动生成绑定。
        /// </summary>
        protected virtual void OnScriptGenerator()
        {
        }
        ...
        /// <summary>
        /// 当触发窗口的层级排序。对Window和其ListChild触发，不会递归触发。
        /// </summary>
        ...
        /// <summary>
        /// 当因为全屏遮挡触或者窗口可见性触发窗口的显隐。对Window和其ListChild触发，不会递归触发。
        /// </summary>
