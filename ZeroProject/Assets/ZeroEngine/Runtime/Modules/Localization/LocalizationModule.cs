/****************************************************
  文件：LocalizationModule.cs
  作者：聪头
  邮箱：1322080797@qq.com
  日期：2024年10月16日 15:20:07
  功能：
*****************************************************/
using UnityEngine;
...
namespace ZeroEngine
{
    ...
    public sealed class LocalizationModule: Module, IResourceManager_Bundles
    {
        ...
        private void Start()
        {
            ...
            //如果rootModule没有设置语言(即为Unspecified)，则默认选择系统语言SystemLanguage，否则选择rootModule指定的语言
        ...
        /// <param name="fromInit">是否从资源模块加载多语言表，否则使用Inspector绑定的。</param>
        public async UniTask LoadLanguage(string language, bool setCurrent = false, bool fromInit = false)
        {
            ...
            //加载解析多语言表
            //第二个参数表示是否加载Localization定义的所有语言
            //此处意思：如果需立刻设置当前语言，就不会加载解析Localization的所有语言，而是解析设置的语言
