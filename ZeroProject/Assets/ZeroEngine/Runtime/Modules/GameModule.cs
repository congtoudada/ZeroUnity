...
namespace ZeroEngine
{
    ...
    public partial class GameModule : MonoBehaviour
    {
        ...
        private static GameObject _goGameModuleRoot;
        ...
        public static void Shutdown(ShutdownType shutdownType)
        {
            ...
            if (_goGameModuleRoot != null)
            {
                Destroy(_goGameModuleRoot);
                _goGameModuleRoot = null;
            }
            _moduleMaps.Clear();
