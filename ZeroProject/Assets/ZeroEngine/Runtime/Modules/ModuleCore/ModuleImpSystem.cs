/****************************************************
  文件：ModuleImpSystem.cs
  作者：聪头
  邮箱：1322080797@qq.com
  日期：2024年08月22日 15:47:03
  功能：
*****************************************************/
...
namespace ZeroEngine
{
    ...
    public static class ModuleImpSystem
    {
        ...
        private const string ModuleRootNameSpace = "ZeroEngine.";

        private static readonly Dictionary<Type, ModuleImp> _moduleMaps = new Dictionary<Type, ModuleImp>(DesignModuleCount); //所有模块的Map
        private static readonly GameFrameworkLinkedList<ModuleImp> _modules = new GameFrameworkLinkedList<ModuleImp>(); //根据优先级降序
        private static readonly GameFrameworkLinkedList<ModuleImp> _updateModules = new GameFrameworkLinkedList<ModuleImp>(); //根据优先级降序
        private static readonly List<ModuleImp> _updateExecuteList = new List<ModuleImp>(DesignModuleCount); //只存储需要轮询的模块
