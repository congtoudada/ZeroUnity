...
namespace ZeroEngine
{
    ...
    {
        private static readonly string GlobalSettingsPath = $"ZeroEngineGlobalSettings"; //相对于Resources的路径
        private static ZeroEngineSettings _globalSettings;

        public static ZeroEngineSettings GlobalSettings
        {
            get
            {
                if (_globalSettings == null)
                {
                    _globalSettings = GetSingletonAssetsByResources<ZeroEngineSettings>(GlobalSettingsPath);
                }
