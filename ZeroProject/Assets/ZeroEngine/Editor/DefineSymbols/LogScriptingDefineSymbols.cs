/****************************************************
  文件：LogScriptingDefineSymbols.cs
  作者：聪头
  邮箱：1322080797@qq.com
  日期：2024年10月17日 15:38:07
  功能：
*****************************************************/
...
namespace ZeroEngine.Editor
{
    ...
    public static class LogScriptingDefineSymbols
    {
        ...
        /// 禁用所有日志脚本宏定义。
        /// </summary>
        [MenuItem("ZeroEngine/Log Scripting Define Symbols/Disable All Logs", false, 30)]
        ...
        /// 开启所有日志脚本宏定义。
        /// </summary>
        [MenuItem("ZeroEngine/Log Scripting Define Symbols/Enable All Logs", false, 31)]
        ...
        /// 开启调试及以上级别的日志脚本宏定义。
        /// </summary>
        [MenuItem("ZeroEngine/Log Scripting Define Symbols/Enable Debug And Above Logs", false, 32)]
        ...
        /// 开启信息及以上级别的日志脚本宏定义。
        /// </summary>
        [MenuItem("ZeroEngine/Log Scripting Define Symbols/Enable Info And Above Logs", false, 33)]
        ...
        /// 开启警告及以上级别的日志脚本宏定义。
        /// </summary>
        [MenuItem("ZeroEngine/Log Scripting Define Symbols/Enable Warning And Above Logs", false, 34)]
        ...
        /// 开启错误及以上级别的日志脚本宏定义。
        /// </summary>
        [MenuItem("ZeroEngine/Log Scripting Define Symbols/Enable Error And Above Logs", false, 35)]
        ...
        /// 开启严重错误及以上级别的日志脚本宏定义。
        /// </summary>
        [MenuItem("ZeroEngine/Log Scripting Define Symbols/Enable Fatal And Above Logs", false, 36)]
