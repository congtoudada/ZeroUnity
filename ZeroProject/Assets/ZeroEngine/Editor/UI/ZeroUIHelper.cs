...
//作者:Saber
#endregion
namespace ZeroEngine.Editor.UI
{
    public class ZeroUIHelper
    {
        public static string Generate(bool includeListener, bool isUniTask = false, Transform root = null, string nameSpace = "",string className="")
        {
            if (root != null)
            {
                ...
                //typeof(ZeroEngine.Editor.UI.ScriptGenerator).GetMethod("Ergodic",System.Reflection.BindingFlags.NonPublic| System.Reflection.BindingFlags.Static).Invoke(null,args);
                ...
                strFile.Append("using ZeroEngine;\n\n");
                ...
                strFile.Append("\t\tprotected override void OnScriptGenerator()\n");
                strFile.Append("\t\t{\n");
