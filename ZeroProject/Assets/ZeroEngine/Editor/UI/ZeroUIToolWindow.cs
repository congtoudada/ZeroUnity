...
{
    public class ZeroUIToolWindow : OdinEditorWindow
    {
        public enum Type
        {
            normal,
        ...
        public void Build()
        {
            var str = ZeroUIHelper.Generate(type == Type.listener || type == Type.all, type == Type.unitask || type == Type.all, root, nameSpace, className);
        ...
        static void OpenWindow()
        {
            ...
            {
                var window = GetWindow<ZeroUIToolWindow>();
                // 设置窗口大小
        ...
        {
            var window = EditorWindow.GetWindow<ZeroUIToolWindow>();
