/****************************************************
  文件：OpenFolderHelper.cs
  作者：聪头
  邮箱：1322080797@qq.com
  日期：2024年10月17日 15:57:20
  功能：
*****************************************************/
...
namespace ZeroEngine.Editor
{
    ...
    public static class OpenFolderHelper
    {
        ...
        /// 打开 Data Path 文件夹。
        /// </summary>
        [MenuItem("ZeroEngine/Open Folder/Data Path", false, 10)]
        ...
        /// </summary>
        [MenuItem("ZeroEngine/Open Folder/Persistent Data Path", false, 11)]
        ...
        /// </summary>
        [MenuItem("ZeroEngine/Open Folder/Streaming Assets Path", false, 12)]
        ...
        /// </summary>
        [MenuItem("ZeroEngine/Open Folder/Temporary Cache Path", false, 13)]
        ...
        /// </summary>
        [MenuItem("ZeroEngine/Open Folder/Console Log Path", false, 14)]
