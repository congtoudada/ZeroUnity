/****************************************************
  文件：ZeroFrameworkLInkedListRange.cs
  作者：聪头
  邮箱：1322080797@qq.com
  日期：2024年04月21日 11:03:51
  功能：
*****************************************************/
...
namespace ZeroFramework
{
    ...
    public readonly struct ZeroFrameworkLinkedListRange<T> : IEnumerable<T>, IEnumerable
    {
        ...
        public ZeroFrameworkLinkedListRange(LinkedListNode<T> first, LinkedListNode<T> terminal)
        {
        ...
        {
            private readonly ZeroFrameworkLinkedListRange<T> m_GameFrameworkLinkedListRange;
            private LinkedListNode<T> m_Current;
            private T m_CurrentValue;

            internal Enumerator(ZeroFrameworkLinkedListRange<T> range)
            {
                if (!range.IsValid)
                {
                    throw new GameFrameworkException("Range is invalid.");
