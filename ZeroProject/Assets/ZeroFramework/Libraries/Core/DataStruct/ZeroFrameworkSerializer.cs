/****************************************************
  文件：ZeroFrameworkSerializer.cs
  作者：聪头
  邮箱：1322080797@qq.com
  日期：2024年04月21日 12:01:06
  功能：
*****************************************************/
...
namespace ZeroFramework
{
    ...
    public abstract class ZeroFrameworkSerializer<T>
    {
        ...
        /// 初始化游戏框架序列化器基类的新实例。
        /// </summary>
        public ZeroFrameworkSerializer()
        {
        ...
        /// <param name="data">要序列化的数据。</param>
        /// <returns>是否序列化数据成功。</returns>
        public bool CallSerialize(Stream stream, T data)
        {
            ...
            return CallSerialize(stream, data, _latestSerializeCallbackVersion);
        }
        ...
        /// <param name="version">序列化回调函数的版本。</param>
        /// <returns>是否序列化数据成功。</returns>
        public bool CallSerialize(Stream stream, T data, byte version)
        {
        ...
        /// <param name="stream">指定流。</param>
        /// <returns>反序列化的数据。</returns>
        public T CallDeserialize(Stream stream)
        {
            byte[] header = GetHeader();
