/****************************************************
  文件：ObjectPoolManager_ObjectPool.cs
  作者：聪头
  邮箱：1322080797@qq.com
  日期：2024年04月23日 16:10:14
  功能：
*****************************************************/
...
{
    internal sealed partial class ObjectPoolManager : ModuleLogic, IObjectPoolManager
    {
        /// <summary>
        /// 对象池。
        /// </summary>
        ...
        {
            private readonly ZeroFrameworkMultiDictionary<string, Object<T>> _objects;
            ...
            public ObjectPool(string name, bool allowMultiSpawn, float autoReleaseInterval, int capacity, float expireTime, int priority)
                : base(name)
            {
                _objects = new ZeroFrameworkMultiDictionary<string, Object<T>>();
            ...
            public bool CanSpawn(string name)
            {
                ...
                ZeroFrameworkLinkedListRange<Object<T>> objectRange = default(ZeroFrameworkLinkedListRange<Object<T>>);
            ...
            public bool ReleaseObject(object target)
            {
                ...
                MemoryPool.Instance.Release(internalObject);
                return true;
            }
            ...
            public override ObjectInfo[] GetAllObjectInfos()
            {
                ...
                foreach (KeyValuePair<string, ZeroFrameworkLinkedListRange<Object<T>>> objectRanges in _objects)
                {
            ...
            internal override void Shutdown()
            {
                foreach (KeyValuePair<object, Object<T>> objectInMap in _objectMap)
                {
                    ...
                    MemoryPool.Instance.Release(objectInMap.Value);
                }
