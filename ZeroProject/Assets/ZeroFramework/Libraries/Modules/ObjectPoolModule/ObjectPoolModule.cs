/****************************************************
  文件：ObjectPoolModule.cs
  作者：聪头
  邮箱：1322080797@qq.com
  日期：2024年04月23日 16:12:12
  功能：
*****************************************************/
...
namespace ZeroFramework
{
    ...
    public sealed class ObjectPoolModule : ModuleBehaviour, IObjectPoolManager
    {
        ...
        protected override void Awake()
        {
            ...
            _objectPoolManager = ModuleLogicSystem.Instance.GetModule<IObjectPoolManager>();
