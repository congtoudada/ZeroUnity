/****************************************************
  文件：ObjectPoolManager_Object.cs
  作者：聪头
  邮箱：1322080797@qq.com
  日期：2024年04月23日 15:35:55
  功能：
*****************************************************/
    ...
    internal sealed partial class ObjectPoolManager : ModuleLogic, IObjectPoolManager
    {
        ...
        private sealed class Object<T> : IMemory where T : ObjectBase
        {
            ...
            public static Object<T> Create(T obj, bool spawned)
            {
                ...
                Object<T> internalObject = MemoryPool.Instance.Acquire<Object<T>>();
            ...
            {
                _object.OnRelease(isShutdown);
                MemoryPool.Instance.Release(_object);
            }
