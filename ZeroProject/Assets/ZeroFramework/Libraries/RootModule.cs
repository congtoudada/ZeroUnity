...
namespace ZeroFramework
{
    ...
    public sealed class RootModule : ModuleBehaviour
    {
        private const int DefaultDpi = 96;  // default windows dpi

        private float m_GameSpeedBeforePause = 1f;
        
        [SerializeField][LabelText("语言")]
        private Language m_EditorLanguage = Language.Unspecified;

        [SerializeField][LabelText("Text帮助类类型")]
        private string m_TextHelperTypeName = "ZeroFramework.DefaultTextHelper";

        [SerializeField][LabelText("Version帮助类类型")]
        private string m_VersionHelperTypeName = "ZeroFramework.DefaultVersionHelper";

        [SerializeField][LabelText("Log帮助类类型")]
        private string m_LogHelperTypeName = "ZeroFramework.DefaultLogHelper";

        [SerializeField][LabelText("Json帮助类类型")]
        private string m_JsonHelperTypeName = "ZeroFramework.DefaultJsonHelper";

        [SerializeField][LabelText("游戏帧率")]
        private int m_FrameRate = 120;

        [SerializeField][LabelText("游戏速度")]
        private float m_GameSpeed = 1f;

        [SerializeField][LabelText("是否后台运行")]
        private bool m_RunInBackground = true;

        [SerializeField][LabelText("是否关闭休眠 (休眠: 节能设置，允许屏幕在无用户交互一段时间后变暗)")]
        ...
        protected override void Awake()
        {
            ...
            InitVersionHelper();
            InitLogHelper();
            Log.Info("ZeroFramework Version: {0}", Version.GameFrameworkVersion);
        ...
        {
            GameTime.Sample();
            ModuleLogicSystem.Instance.Update(GameTime.deltaTime, GameTime.unscaledDeltaTime);
        }
