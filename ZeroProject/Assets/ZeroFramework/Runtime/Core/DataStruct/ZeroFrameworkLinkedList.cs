/****************************************************
  文件：ZeroFrameworkLinkedList.cs
  作者：聪头
  邮箱：1322080797@qq.com
  日期：2024年04月21日 10:13:16
  功能：
*****************************************************/
...
namespace ZeroFramework.Runtime
{
    ...
    public sealed class ZeroFrameworkLinkedList<T> : ICollection<T>, IEnumerable<T>, ICollection, IEnumerable
    {
        ...
        /// 初始化游戏框架链表类的新实例。
        /// </summary>
        public ZeroFrameworkLinkedList()
        {
        ...
        /// <summary>
        /// 获取可用于同步对 ICollection 的访问的对象。用法: lock(syncRoot){ //do something... }
        /// </summary>
